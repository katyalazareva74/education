...
Команда `git commit -am "text"` добавляет и сохраняет изменения. Команда правильно работает, если в репозитории только один файл. Если файлов несколько, то изменения сохранятся в каждом файле.

Команда `git commit --amend -am "text"` сохраняет изменения в последнем коммите. Команда правильно работает, если в репозитории только один файл. Если файлов несколько, то изменения сохранятся в каждом файле.
